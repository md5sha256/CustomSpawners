...
public class Config extends YamlConfiguration {
    ...
    /**
     * Makes a new Config instance that will manage one configuration file.
     * <p>
     * NB: Make sure you created the file with the exact same name and all
     * the default values inside of your plugin in the src/config/resources folder!
     *
     ...
     * @return
     */
    public Config(String fileName, boolean useDefaults) {
